          ...
          <div className="cs_post cs_style_1" key={post.id}>
            ...
            <div className="cs_post_info">
              <div className="cs_post_meta cs_style_1">
                ...
                <Link to="#" className="cs_post_avatar" dangerouslySetInnerHTML={{ __html: post.category }} />
              </div>
              ...
              <div className="cs_post_sub_title" dangerouslySetInnerHTML={{ __html: post.description }} />

              <Link to={post.link} className="cs_btn cs_style_2 cs_bold cs_heading_color">
                {language === "me" ? "Pročitaj više" : "See More"}
              </Link>
            </div>
          </div>
        ))}
